...
class UbloxGps(object):
    ...
    def scale_NAV_HPPOSLLH(self, nav_payload):
        ...
        nav_payload = nav_payload._replace(flags=status)
    ...
    def scale_NAV_PVT(self, nav_payload):
        ...
        nav_payload = nav_payload._replace(fixType = gnn_fixtype)
    ...
    def scale_NAV_VELNED(self, nav_payload):
        ...
        gps_tow = nav_payload.iTOW
        north_vel = nav_payload.velN
        east_vel = nav_payload.velE
        down_vel = nav_payload.velD

        # velned_course_acc = nav_payload.cAcc
        # att_head = nav_payload.heading

        nav_payload = nav_payload._replace(iTOW = gps_tow)
        nav_payload = nav_payload._replace(velN = north_vel)
        nav_payload = nav_payload._replace(velE = east_vel)
        nav_payload = nav_payload._replace(velD = down_vel)
